...
THREE.Water = function ( geometry, options ) {
	...
	var normalMap0 = options.normalMap0 || textureLoader.load( './src/three/examples/textures/water/Water_1_M_Normal.jpg' );
	var normalMap1 = options.normalMap1 || textureLoader.load( './src/three/examples/textures/water/Water_2_M_Normal.jpg' );
...
THREE.Water.WaterShader = {
	...
	fragmentShader: [
		...
		'	vec4 reflectColor = texture2D( tReflectionMap, vec2( 2.0 - uv.x, uv.y ) );',
